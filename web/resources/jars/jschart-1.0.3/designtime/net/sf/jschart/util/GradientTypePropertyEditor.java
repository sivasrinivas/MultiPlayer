...
public class GradientTypePropertyEditor extends PropertyEditorSupport
{
    ...
    private static void addType(String newType)
    {
        chartTypes.put( newType, DesignUtil.getInstance().getMessage(
                GradientTypePropertyEditor.class, "GradientTypePropertyEditor." + newType ));
    }
    
    static
    {
        for(String t : new String[] { "vertical", "horizontal", "centerVertical", "centerHorizontal" } )
            addType( t );
    }
