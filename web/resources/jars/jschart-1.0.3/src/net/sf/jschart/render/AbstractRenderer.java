 ...
 * <code>javax.faces.render.Renderer</code> for the <em>Widgets Library</em>.
 * </p>
 */
...
public abstract class AbstractRenderer extends Renderer
{
     ...
     * </p>
     */
    public static final String EVENTS_ATTRIBUTES[] = { "onclick", "ondblclick",
    ...
    /**
     * <p>
     * Decode any new state of the specified <code>UIComponent</code> from the
     * request contained in the specified <code>FacesContext</code>, and
     * store that state on the <code>UIComponent</code>.
     * </p>
     *
     * <p>
     * The default implementation calls <code>setSubmittedValue()</code>
     * unless this component has a boolean <code>disabled</code> or
     * <code>readonly</code> attribute that is set to <code>true</code>.
     * </p>
     *
     * @param context
    ...
    /**
     * <p>
     * Render the beginning of the specified <code>UIComponent</code> to the
     * output stream or writer associated with the response we are creating.
     * </p>
     *
     * <p>
     * The default implementation calls <code>renderStart()</code> and
     * <code>renderAttributes()</code>.
     * </p>
     *
     * @param context
     *            <code>FacesContext</code> for the current request
    ...
    /**
     * <p>
     * Render the children of the specified <code>UIComponent</code> to the
     * output stream or writer associated with the response we are creating.
     * </p>
     *
     * <p>
    ...
    /**
     * <p>
     * Render the ending of the specified <code>UIComponent</code> to the
     * output stream or writer associated with the response we are creating.
     * </p>
     *
     * <p>
     * The default implementation calls <code>renderEnd()</code>.
     * </p>
     *
     * @param context
     *            <code>FacesContext</code> for the current request
    ...
    /**
     * <p>
     * Return the <code>Application</code> instance for this web application.
     * </p>
     */
     ...
     * the String representation (if necessary), or <code>null</code> if the
     * String representation is null.
     * </p>
     *
     * @param context
     *            FacesContext for the current request
     * @param component
     *            Component whose value is being processed (must be a component
     *            that implements ValueHolder
     * @param value
     ...
     *            FacesContext for the current request
     * @param component
     *            Component whose value is to be retrieved (must be a component
     *            that implements ValueHolder)
     */
    ...
    /**
     * <p>
     * Return <code>true</code> if the specified component is disabled.
     * </p>
     *
     * @param component
     *            <code>UIComponent</code> to be checked
     */
    ...
    /**
     * <p>
     * Return <code>true</code> if the specified component is read only.
     * </p>
     *
     * @param component
     *            <code>UIComponent</code> to be checked
     ...
     * <code>writeAttribute()</code> and <code>writeURIAttribute</code> on
     * the specified <code>ResponseWriter</code>.
     * </p>
     *
     * <p>
     ...
     *            <code>FacesContext</code> for the current request
     * @param component
     *            <code>EditableValueHolder</code> component whose submitted
     *            value is to be stored
     * @param writer
     *            <code>ResponseWriter</code> to which the element start
     *            should be rendered
     *
     * @exception IOException
     *                if an input/output error occurs
    ...
    /**
     * <p>
     * Render the "core" set of attributes for this <code>UIComponent</code>.
     * The default implementation conditionally generates the following
     * attributes with values as specified.
     * </p>
     * <ul>
     * <li><strong>id </strong>- If this component has a non-
     * <code>null</code>
     *     <code>id</code> property, and the identifier does
     * not start with <code>UIViewRoot.UNIQUE_ID_PREFIX</code>, render the
     * <code>clientId</code>.</li>
     * <li><strong>class </strong>- If this component has a non-
     * <code>null</code> <code>styleClass</code> attribute, render its
     * value, combined with the syles parameter (if any).</li>
     * <li><strong>style </strong>- If this component has a non-
     * <code>null</code> <code>style</code> attribute, render its value.
     * </li>
     * <li><strong>title </strong>- If this component has a non-
     * <code>null</code> <code>title</code> attribute, render its value.
     * </li>
     * </ul>
     *
     * @param context
     ...
     *            should be rendered
     * @param styles
     *            Space-separated list of CSS style classes to add to the
     *            <code>class</code> attribute, or <code>null</code> for
     *            none
     *
     * @exception IOException
     *                if an input/output error occurs
     */
    protected void renderCoreAttributes(FacesContext context,
            ...
            throws IOException
    {
        ...
        // System.out.println("classes(" + component.getId() + "," +
     ...
     * <code>endElement()</code> on the specified <code>ResponseWriter</code>.
     * </p>
     *
     * <p>
     * The default implementation does nothing.
     ...
     * specified <code>UIComponent</code>.
     * </p>
     *
     * @param context
     *            <code>FacesContext</code> for the current request
     ...
     *                if an input/output error occurs
     */
    protected void renderBoolean(FacesContext context, UIComponent component,
            ResponseWriter writer, String names[]) throws IOException
    {
     ...
     * <code>ResponseWriter</code> for which the specified
     * <code>UIComponent</code> has a non- <code>null</code> attribute
     ...
     * component. Simple renderers that create a single markup element for this
     * component should override this method and include a call to
     * <code>startElement()</code> on the specified
     ...
     * <code>EditableValueHolder</code>. If so, it checks for a request
     * parameter with the same name as the <code>clientId</code> of this
     * <code>UIComponent</code>. If there is such a parameter, its value is
     * passed (as a String) to the <code>setSubmittedValue()</code> method on
     * the <code>EditableValueHolder</code> component.
     * </p>
     *
     * @param context
     *            <code>FacesContext</code> for the current request
     ...
     * component, or <code>null</code> for none.
     * </p>
     *
     * @param component
     *            <code>UIComponent</code> for which to calculate classes
     * @param styles
     *            Additional styles specified by the renderer
     */
